...
////////////////////////////////////////////////////////////////
  ...
  ball_22 = Bodies.circle(random(width), random(-randomYPos * 23), circleRadius);
  ...
  bar_23 = Bodies.rectangle(random(width), random(-randomYPos * 24, randomYPos_02), rectWidth, rectHeight);
...
function keyTyped() {
  if (bEnableExport) {
    if ((key === 'f') || (key === 'F')) {
      bRecording = true;
      frameRate(24); // while we're exporting
      nElapsedFrames = 0;
    }
  }
}
